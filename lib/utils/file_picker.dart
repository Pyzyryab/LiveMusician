...
class LiveMusicianFilePicker extends StatefulWidget {
  @override
  _LiveMusicianFilePickerState createState() => _LiveMusicianFilePickerState();
}

class _LiveMusicianFilePickerState extends State<LiveMusicianFilePicker> {
